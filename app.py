#!/usr/bin/env python
# NOTE: This file is meant to be run from the backend directory with its virtual environment.
# Please use `./start-backend.sh` script instead of running this file directly.
